...
If LoRaWAN cannot be joined outside the school gateway coverage, the firmware continues normally and prints clearly marked `LoRa offline demo` status lines to show which AT+MSG messages would be sent.
